...
export function generateProposalHtml(
  ...
  const accent = biz.accent || "#5b642e";
  const accentDark = biz.accent_dark || "#454d23";
  const stripeColor = accentDark;
...
<div ${wrap}>
  ...
  <div style="display:flex;justify-content:space-between;align-items:flex-start;padding-bottom:28px;">
    ...
    <div style="text-align:right;">
      ...
      <p style="margin:0 0 10px;font-size:13px;font-weight:bold;text-transform:uppercase;letter-spacing:0.16em;color:${accent};">Custom Fabrication</p>
  ...
  <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
    <tr>
      <td style="width:50%;vertical-align:top;padding-right:24px;">
        <p style="margin:0 0 10px;font-size:10px;font-weight:bold;text-transform:uppercase;letter-spacing:0.14em;color:${accent};">Prepared For</p>
  ...
  ${forEmail && approveUrl ? `
  <div style="padding:28px 20px;background:#faf8f3;border-top:3px solid ${accent};border-bottom:3px solid ${accent};text-align:center;">
    ...
    <a href="${approveUrl}" style="display:inline-block;background:${accentDark};color:#fff;text-decoration:none;padding:16px 40px;font-size:16px;font-weight:bold;letter-spacing:0.04em;">✓ &nbsp;Approve This Proposal</a>
...
export function generateEstimateProposalHtml({
  ...
  const acceptanceSection = approveUrl
    ? `
  <div style="margin-top:36px;padding:24px;background:#fafafa;border:1px solid #e5e5e5;border-left:3px solid ${accent};page-break-inside:avoid;">
    ...
    <a href="${approveUrl}" style="display:inline-block;background:${accentDark};color:#fff;padding:14px 28px;text-decoration:none;font-weight:bold;letter-spacing:0.08em;font-size:13px;text-transform:uppercase;">
      Review &amp; Sign
    </a>
  </div>`
    : `
  ...
  <section class="proposal-page proposal-cover" style="${cardBaseStyle}page-break-after:always;display:flex;flex-direction:column;align-items:center;text-align:center;min-height:8.25in;">
    ...
    <div style="margin-bottom:18px;">
      ...
      <p style="margin:4px 0 0;font-size:13px;font-weight:bold;text-transform:uppercase;letter-spacing:0.18em;color:${accent};">Custom Fabrication</p>
